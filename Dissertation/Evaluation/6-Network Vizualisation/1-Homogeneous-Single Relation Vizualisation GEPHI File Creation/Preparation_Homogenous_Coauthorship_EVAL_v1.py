...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 15:17:53 2020
...
for author1,author2 in auth_recommended_dict["primary_pairs"]:
    ...
    if not tuple((author1,author2)) in Primary_edge_dict and not tuple((author2,author1)) in Primary_edge_dict:
        Primary_edge_dict[tuple((author1,author2))] = (True, edge_weight_threshold, "primary_pairs")
...
for author1,author2 in auth_recommended_dict["secondary_pairs"]: 
    ...
    if not author2 in Primary_author_dict:
        Primary_author_dict[author2] = False
    if not tuple((author1,author2)) in Primary_edge_dict and not tuple((author2,author1)) in Primary_edge_dict:
        Primary_edge_dict[tuple((author1,author2))] = (True, edge_weight_threshold, "secondary_pairs")
...
cnt = 0
with open("./muxViz-master/MultiGraph_edge_colour_size_COAUTHOR.txt", "w", encoding="utf-8") as file:
...
with open("./muxViz-master/MultiGraph_node_CONFIG_COAUTHOR.txt", "w", encoding="utf-8") as file:
